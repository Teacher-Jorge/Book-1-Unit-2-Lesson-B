...
input1.addEventListener('keyup', (e) => {
    if(input1.value === "Are these my keys") {
...
input2.addEventListener('keyup', (e) => {
    if(input2.value === "What are these? They're dictionaries") {
...
input3.addEventListener('keyup', (e) => {
    if(input3.value === "These are good sandwiches") {
...
input4.addEventListener('keyup', (e) => {
    if(input4.value === "What's this? It's a tablet"|| input4.value === "What is this? It's a tablet") {
...
input5.addEventListener('keyup', (e) => {
    if(input5.value === "My child isn't in class today") {
...
input6.addEventListener('keyup', (e) => {
    if(input6.value === "Is this your pencil? Yes, it is") {
